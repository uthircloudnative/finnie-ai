...
3.  **Data Sourcing Blueprint**: Detailed the exact sources (Investopedia, IRS, SEC, Vanguard, Alpha Vantage), update frequencies, and content types for all 5 collections.
...
- Scrape 10-20 core financial terms from Investopedia to "prime" the system.
